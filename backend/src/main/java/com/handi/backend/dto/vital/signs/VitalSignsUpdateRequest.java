...
@Schema(description = "활력징후 수정")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor

public class VitalSignsUpdateRequest {
    ...
    @Schema(description = "키 (cm)", example = "165.0", nullable = true)
    private BigDecimal height;

    @Schema(description = "몸무게 (kg)", example = "65.0", nullable = true)
